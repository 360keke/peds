...
import cn.com.framework.dao.StringClob;
...
public class StringUtils {
	...
	public static Object convert(Class type, String var) throws SystemException {
		...
		if ((type.getName().equalsIgnoreCase("java.sql.Date"))
		...
		if ((type.getName().equalsIgnoreCase("java.lang.Boolean"))
