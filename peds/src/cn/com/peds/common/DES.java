...
public class DES {
	private static String strDefaultKey = PropertyManager
			.getProperty("security.defaultkey");// PropertyManager.getProperty("security.defaultkey");
	...
	public static void main(String[] args) throws Exception {
		DES des = new DES();
		System.out.println(des.encrypt("金融交易学  一个专业投资者的至深感悟  第2卷（高清）"));
