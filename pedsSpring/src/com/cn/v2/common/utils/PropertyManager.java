...
public class PropertyManager {
	...
	private static String propsName = "/peds-config.properties";
	...
	private void saveProps() {
		// String path = ResourceBundle.getBundle("DataBase.properties")
	...
	public synchronized static int getSequence(String key) {
		int temp = Integer.parseInt(getProperty(key));
		int value = temp + 1;
	 ...
	 * (Thread.currentThread().getContextClassLoader().getResource("")); System.out
	 * .println(PropertyManager.class.getClassLoader().getResource("")); System.out.println(ClassLoader.getSystemResource(""));
	 * System.out.println(PropertyManager.class.getResource("")); System.out.println(PropertyManager.class.getResource("/").getPath());
